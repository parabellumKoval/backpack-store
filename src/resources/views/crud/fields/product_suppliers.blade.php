...
<div class="suppliers-container">
    ...
    @foreach($field['value'] as $key => $item)
        @include('vendor.backpack.crud.fields.inc.supplier_template', ['key' => $key, 'item' => $item, 'currencies' => $currencies])
    @endforeach
...
(function($){
  ...
  const supplierTemplate = `{!! str_replace("\n", "", addslashes(view('vendor.backpack.crud.fields.inc.supplier_template', [
      'field' => $field,
      'suppliers' => $suppliers,
